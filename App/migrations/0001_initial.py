# Generated by Django 4.2.2 on 2023-06-15 15:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analyzer', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='App.device', verbose_name='Оборудование')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='App.customer', verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='App.deviceinfield', verbose_name='Оборудование')),
            ],
            options={
                'verbose_name': 'Заявка',
